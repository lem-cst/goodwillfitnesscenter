    ...
    <div class="header_section">
        <div class="container-fluid">
            <div class="row">
                ...
                <span  style="font-size:33px;cursor:pointer; color: payment2.phpffffff;" onclick="openNav()"><img src="images/toggle.png" class="toggle_menu"></span>
                </div>  
                </li>
                        </ul>
                    </div>
        ...
        <div class="footer_section_2">
          <div class="container">
            ...
            <div class="social_icon">
              <ul>
                <li><a href="payment2.php"><img src="images/fb-icon.png"></a></li>
                <li><a href="payment2.php"><img src="images/twitter-icon.png"></a></li>
                <li><a href="payment2.php"><img src="images/in-icon.png"></a></li>
                <li><a href="payment2.php"><img src="images/instagram-icon.png"></a></li>
              </ul>
            </div>
          </div>
        </div>
